export default function EmployeeCard({
    ...
    return (
        <div style={{backgroundColor: color, fontSize: 16, lineHeight:1.5}}>
            ...
            <h1 style={{textTransform: "lowercase", fontSize: 20, fontweight:800}}>{firstname} {lastname}</h1>
            ...
            <h4 style={{textTransform:"uppercase", fontSize:14, fontWeight:100}}>{yearsworked} years exp. producing great media</h4><br></br>
            <p style={{fontFamily: "Arial, Helvetica, sans-serif", margin:"10px"}}>{description}</p><br></br>
        </div>
    )
}