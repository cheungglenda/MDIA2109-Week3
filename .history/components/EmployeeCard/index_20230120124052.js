export default function EmployeeCard({
    ...
    return (
        <div style={{backgroundColor: color, fontSize: 16}}>
            ...
            <h4 style={{textTransform:"lowercase", fontSize:16, fontWeight:100}}>{yearsworked} years with pug media co.</h4><br></br>
            <p style={{fontFamily: "Arial, Helvetica, sans-serif"}}>{description}</p><br></br>
        </div>
    )
}