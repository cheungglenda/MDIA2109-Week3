export default function Card({
    ...
    return (
        <div>
        {
            ...
            firstname === "Jennifer" ? <img style={{objectFit: "cover"}} src={'jennifer.jpeg'} width="300" height="300"/> :             
            ...
            <p style={{fontFamily: "'Courier New', Courier, monospace", margin:"10px", width:"460px"}}>{description}</p><br></br>
        </div>
    )
}