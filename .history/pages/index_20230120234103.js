...
import homeData from '../data/education.json'
...
export default function Home() {
  ...
  const [information, setInformation] = useState([...homeData])
  ...
  return (
    <>
      ...
      <Link href="/" className={styles.links}>Contact</Link>
        ...
        <div className={styles.meetTitle}>Meet the Founders</div>
