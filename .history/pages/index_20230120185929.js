      ...
      <Link href="/" className={styles.links}>Contact</Link>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.homeDesc}>
            Pug Media Co. is an independent creative full-service media agency developing content on a global scale.<br></br>Pug Media Co. specializes in SEO, web design, and branding. We have helped many clients from various industries, and hope to help you achieve your goals as well!
          </div>
        </div>
